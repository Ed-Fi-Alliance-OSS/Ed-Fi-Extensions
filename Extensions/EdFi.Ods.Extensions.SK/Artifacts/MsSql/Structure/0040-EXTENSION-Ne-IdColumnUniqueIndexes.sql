BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'ne.AssessmentAdministration') AND name = N'UX_AssessmentAdministration_Id')
    CREATE UNIQUE NONCLUSTERED INDEX UX_AssessmentAdministration_Id ON [ne].[AssessmentAdministration]
