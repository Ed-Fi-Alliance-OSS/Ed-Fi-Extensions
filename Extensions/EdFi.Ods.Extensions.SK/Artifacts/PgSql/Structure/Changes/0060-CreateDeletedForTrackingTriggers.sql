CREATE FUNCTION tracked_deletes_ne.AssessmentAdministration_TR_DelTrkg()
    RETURNS trigger AS
$BODY$
BEGIN
...
CREATE TRIGGER TrackDeletes AFTER DELETE ON ne.AssessmentAdministration 
    FOR EACH ROW EXECUTE PROCEDURE tracked_deletes_ne.AssessmentAdministration_TR_DelTrkg();
