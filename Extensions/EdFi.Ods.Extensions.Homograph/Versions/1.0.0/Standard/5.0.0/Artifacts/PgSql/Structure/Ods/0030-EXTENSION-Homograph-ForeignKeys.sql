...
ALTER TABLE homograph.Contact ADD CONSTRAINT FK_5f7953_Name FOREIGN KEY (ContactFirstName, ContactLastSurname)
REFERENCES homograph.Name (FirstName, LastSurname)
;

ALTER TABLE homograph.ContactAddress ADD CONSTRAINT FK_cc3333_Contact FOREIGN KEY (ContactFirstName, ContactLastSurname)
REFERENCES homograph.Contact (ContactFirstName, ContactLastSurname)
ON DELETE CASCADE
;

CREATE INDEX FK_cc3333_Contact
ON homograph.ContactAddress (ContactFirstName ASC, ContactLastSurname ASC);

ALTER TABLE homograph.ContactStudentSchoolAssociation ADD CONSTRAINT FK_23ef78_Contact FOREIGN KEY (ContactFirstName, ContactLastSurname)
REFERENCES homograph.Contact (ContactFirstName, ContactLastSurname)
ON DELETE CASCADE
;

CREATE INDEX FK_23ef78_Contact
ON homograph.ContactStudentSchoolAssociation (ContactFirstName ASC, ContactLastSurname ASC);

ALTER TABLE homograph.ContactStudentSchoolAssociation ADD CONSTRAINT FK_23ef78_StudentSchoolAssociation FOREIGN KEY (SchoolName, StudentFirstName, StudentLastSurname)
