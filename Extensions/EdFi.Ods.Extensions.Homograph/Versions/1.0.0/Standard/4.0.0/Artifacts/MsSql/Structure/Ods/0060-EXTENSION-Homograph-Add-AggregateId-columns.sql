...
CREATE SEQUENCE [homograph].[Parent_AggSeq] START WITH -2147483648 INCREMENT BY 1;
ALTER TABLE [homograph].[Parent] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[Parent_AggSeq];
