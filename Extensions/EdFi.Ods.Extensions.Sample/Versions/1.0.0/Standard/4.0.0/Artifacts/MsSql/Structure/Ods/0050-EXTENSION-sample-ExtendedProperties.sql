...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Some text field', @level0type=N'SCHEMA', @level0name=N'sample', @level1type=N'TABLE', @level1name=N'StudentAcademicRecordExtension', @level2type=N'COLUMN', @level2name=N'SomeText'
GO
